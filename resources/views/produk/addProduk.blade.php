        ...
        <div class="min-w-full mx-auto">
            <div class="dark:bg-gray-800 overflow-hidden sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 font-semibold text-2xl">
                    {{ __('Daftar Produk > Tambah Produk') }}
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="col-span-2">
                    <div class="flex flex-col ">
                        ...
                        <input type="text" name="produk_name" id="produk_name" value="{{ old('produk_name') }}"
                            class="rounded" placeholder="masukan nama" autocomplete="off" required>
                    </div>
                </div>
                <div class="col-span-1">
                    <div class="flex flex-col ">
                ...
                <div class="col-span-1">
                    <div class="flex flex-col ">
                        ...
                        <input type="number" name="harga_jual" id="harga_jual" value="{{ old('harga_jual') }}"
                            class="rounded" placeholder="masukan harga jual" readonly>
                    </div>
                </div>
                <div class="col-span-1">
                    <div class="flex flex-col ">
                        <label for="stok" class="mb-2">Stok</label>
                        <input type="number" name="stok" id="stok" class="rounded" value="{{ old('stok') }}"
